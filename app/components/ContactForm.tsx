...
export default function ContactForm() {
  ...
  return (
    <div className="max-w-screen sm:max-w-90% md:max-w-80% mx-auto px-3 sm:px-0 flex flex-col space-y-8">
      {/* Contact Form */}
      <div className="bg-gradient-to-br from-theme-black/60 to-theme-black/50 border-2 border-theme-white/30 p-4 sm:p-6 rounded-xl shadow-lg shadow-theme-black/30 hover:bg-gradient-to-br hover:from-theme-black/70 hover:to-theme-black/60 hover:border-theme-white/40 transition duration-300 relative overflow-hidden">
