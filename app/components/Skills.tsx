...
function SkillCategory({ title, icon, skills }: SkillCategoryProps) {
  return (
    <div className="bg-gradient-to-br from-theme-black/60 to-theme-black/50 border-2 border-theme-white/30 pt-4 pb-6 px-4 sm:px-8 sm:pt-5 sm:pb-8 flex flex-col text-theme-lightgray space-y-6 rounded-xl shadow-lg shadow-theme-black/30 hover:bg-gradient-to-br hover:from-theme-black/70 hover:to-theme-black/60 hover:border-theme-white/40 transition-all duration-300 group relative overflow-hidden h-full">
